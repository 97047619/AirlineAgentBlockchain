...
async function main() {
    try {
		...
		// from 2 to 3
		result = await contract.submitTransaction('TransferFrom', 'x509::/OU=client/CN=user1::/C=US/ST=North Carolina/O=Hyperledger/OU=Fabric/CN=agent1ca-ca', 'x509::/OU=client/CN=user1::/C=US/ST=North Carolina/O=Hyperledger/OU=Fabric/CN=peerairline1-ca', '1000');
