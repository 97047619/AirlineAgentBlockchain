...
exports.createAirlineTicket = async function(airlineTicketId, depart, arrive, owner, price, status) {
    let response = {};
    try {
        ...
        await contract.submitTransaction('createAirlineTicket', airlineTicketId, depart, arrive, owner, price, status);
        console.log('Transaction has been submitted');

        // Disconnect from the gateway.
        await gateway.disconnect();

        response.msg = 'createAirlineTicket Transaction has been submitted';
        return response;
...
// delete ticket transaction
exports.deleteAirlineTicket = async function(airlineTicketId) {
    let response = {};
    try {
        ...
        await contract.submitTransaction('deleteAirlineTicket', airlineTicketId);
        console.log('Transaction has been submitted');

        // Disconnect from the gateway.
        await gateway.disconnect();

        response.msg = 'deleteAirlineTicket Transaction has been submitted';
        return response;
